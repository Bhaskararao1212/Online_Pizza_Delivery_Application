...
session_start();
$_SESSION['ill']=$_SESSION['il'];
$_SESSION['en']=$_POST['orderId'];
$_SESSION['n']=$_POST['message'];
...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (password_verify($password, $passRow['password'])){
        ...
        echo '<script>alert("Thanks for Contact us. Your contact id is ' .$contactId. '. We will contact you very soon.");
                    window.location.href="http://localhost/OnlinePizzaDelivery/partials/_footer1.php";  
                    </script>';
                    exit();
    }
    else{
