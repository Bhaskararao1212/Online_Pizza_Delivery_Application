                        ...
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                                ...
                                <input type="email" class="form-control" id="email" name="email" placeholder="Enter Your Email" required value="<?php echo $_SESSION['il'] ?>">
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                          ...
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                              ...
                              <input class="form-control" type="text" id="orderId" name="orderId" placeholder="Order Id" value="0" method="post">
                          ...
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                              ...
                              <input class="form-control" id="password" name="password" placeholder="Enter Password" type="password" placeholder="Enter Your Password" required data-toggle="password" value="123456789">
                            </div>
                          </div>
                          <div class="col-lg-12">
                            <div class="form-group  mt-3">
                                <textarea class="form-control" id="message" name="message" rows="2" required minlength="6" placeholder="How May We Help You ?" post="method"></textarea>
                            </div>
                          </div>
                          <?php if($loggedin){ ?>
                            <div class="col-lg-12">
                    ...
                    echo '<div class="col-lg-4 bg-image" style="background-image:url(img/contact.jpg)">
                          <div class="detail-box p-4">
                            ...
                            <div class="round-social light">
                              ...
                              <a href="https://github.com/Bhaskararao1212" class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-github"></i></i></a>
